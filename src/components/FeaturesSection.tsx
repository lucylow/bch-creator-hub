...
const audiences = [
  {
    ...
    description: 'Bloggers, YouTubers, podcasters, writers.',
    benefits: [
      'Tips, premium unlocks, and subscriptions from one link',
      'Pay-per-listen for podcasts, paywalled articles for blogs',
      'Real-time dashboard—see what drives revenue across platforms',
    ],
    accent: 'primary',
  },
  {
    ...
    description: 'Digital art, music, commissions, merchandise.',
    benefits: [
      'NFT subscriptions and exclusive content with CashTokens',
      'Commissions, pre-orders, and limited editions in one place',
      'Subscription access to music or art libraries—you set the gate',
    ],
    accent: 'secondary',
  },
  {
    icon: Code,
    title: 'Developers',
    description: 'Open source, SaaS, APIs, courses.',
    benefits: [
      'Donations and sponsor payments for open-source projects',
      'Pay-per-use APIs and subscription access to tools or courses',
      'REST API, webhooks, embeds—audit, fork, self-host if you want',
    ],
    accent: 'primary',
  },
  {
    icon: Rocket,
    title: 'Entrepreneurs',
    description: 'Startups, services, consulting, events.',
    benefits: [
      'Early adopter payments, retainers, and consulting hours in BCH',
      'Ticket sales and registration fees with one payment layer',
      'No chargebacks, no middlemen—unified earnings you control',
    ],
    accent: 'secondary',
  },
];
